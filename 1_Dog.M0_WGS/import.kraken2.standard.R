...
ps  <- import.krona.files(indir = 'Toti_host_removed_kraken2_standard', sampdat.all = sampdat.all)
...
ps.kraken2 <- combine_ps(ps, merge_vars = c('Vregion', 'workflow', 'db', 'platform', 'sample_name'))
...
saveRDS(ps.kraken2, 'Toti_Illumina_WGS_kraken2_Standard_PS.rds')
