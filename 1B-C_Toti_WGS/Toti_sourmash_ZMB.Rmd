...
ps.all <- readRDS("Toti_Illumina_WGS_sourmash.k31_NCBI_PS.rds")
...
ggtop20    <- plotfun(
  ...
  theme(legend.position = 'right',
        panel.grid.major.x = element_blank(),
        axis.text.x = element_blank()) #+ ggtitle(paste0('Top', top, ' ', t))


dir.create('Article_Figures')
ggsave(paste0('Article_Figures', '/', 'Figure_3_sourmash.png'), ggtop20, width = 7, height = 14)
