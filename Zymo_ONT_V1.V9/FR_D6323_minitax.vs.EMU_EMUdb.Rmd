---
title: "Zymo D6323 Fecal Reference: kraken2 WGS (theoretical) against V1-V9 EMU AND minitax on EMU database"
author: "Balázs Kakuk"
date: "2024-10-20"
...
writetables  <- T
save.Figs    <- F
res.dir      <- 'FR_D6323_minitax.vs.EMU_EMUdb'; dir.create(res.dir)
...
GS_version <- 'D6323'
just_GS <- T
vars <- c('platform', 'primer') # 'GS_name' ('project') # c('DNA_isolation_method', 'db', 'workflow', 
