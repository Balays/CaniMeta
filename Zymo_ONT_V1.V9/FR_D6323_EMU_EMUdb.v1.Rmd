---
title: "Zymo D6323 Fecal Reference: kraken2 WGS (theoretical) against V1-V9 EMU on EMU database"
author: "Balázs Kakuk"
date: "2024-10-20"
output:
  html_document:
...
## Filtering samples
filter.samples.pattern <- 'LCA|Undetermined|SpeciesEstimate|BestAln'  ### 
...
zymo.GS <- read_delim('../standards/Zymo.D6323.DNA.report/zymo_D6323_data_corrected.tsv')

## Taxonomy of GS
gs.lineage <- 'GS' ## ->> Use the provided 
## OR: 'db' -->> this will merge the GS data with the database on species-level
...
### Format Zymo GS abundance table

## Important note: In the Zymo FR6323 'Report.html', there is a mix-up between the rank levels - all levels below 'Phylum.'
## The 'X', 'Y' and 'Z' are all should be 'Strain' IMO, but they are shown as 'Family', 'Genus' and 'Species'; while
## the 'Genus' is shown as 'Class' and the 'Species' as 'Order.' 
## So here we show the column in which 'g__' prefix as the genus and 's__' as species and discard the remaining columns.
...
#zymo.GS <- read_delim('../standards/Zymo.D6323.DNA.report/zymo_D6323_data.tsv')
#count_colname <- 'count'
...
#  *Fecal Reference*: Relative abundance of taxa at each taxonomic level
...
The correlations between the theoretical and observed composition are shown. Unclassified reads are not omitted.
