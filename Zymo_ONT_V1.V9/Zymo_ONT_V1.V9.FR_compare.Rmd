...
writetables  <- T
save.Figs    <- F
res.dir      <- 'Zymo_ONT_V1.V9_EMU_EMUdb_FR_compare'; dir.create(res.dir)
...
res.dir <- 'Zymo_ONT_V1.V9_EMU_EMUdb_FR_compare'
...
#  *Zymo ONT V1-V9 FR vs Homo sapiens and Canis lupus comparison*

```{r}

samples.to.keep <- grep('FR|human|canis', sample_names(ps.all), value = T)
...
ggsave(paste0('Article_Figures/', 'Figure_6.png'), width = 9, height = 20)
