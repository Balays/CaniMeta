---
title: "Canis lupus : EMU on EMU database"
author: "Balázs Kakuk"
date: "2024-10-20"
...
writetables  <- T
save.Figs    <- F
res.dir      <- 'Clupus_EMU_EMUdb'; dir.create(res.dir)
...
de.seq <- DESeq(de.seq,  test = "Wald", fitType = "mean", sfType = "poscounts" )
...
figw   <- min(max(4*sigtaxa_N, 8), 24)
figh   <- min(max(fig.width*2, 16), 32)
...
ggsf <- ggplot(sig.frq, aes(is.significant, N)) +
  ...
  labs(title = "Number of Significantly Different Taxa Between ZMB and ZHMW",
